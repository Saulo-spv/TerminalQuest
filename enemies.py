...
monsters = [
    Enemy("Monstro da Procrastinação", "Um ser nebuloso e enganador que adia tarefas e compromissos. Ele causa distrações e tenta desviar a atenção do jogador.", 70, 15, "Motivação", "Desvio de Atenção"),
    Enemy("Espírito da Ansiedade", "Uma entidade perturbadora que causa nervosismo e pânico. Aumenta a dificuldade dos desafios enfrentados pelo jogador.", 80, 20, "Calma e Planejamento", "Crise de Ansiedade"),
